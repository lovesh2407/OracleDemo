...
func (am AppModule) OnRecvPacket(
	...
	case *types.OraclePacketData_IbcPacketPacket:
		packetAck, err := am.keeper.OnRecvIbcPacketPacket(ctx, modulePacket, *packet.IbcPacketPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeIbcPacketPacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.OraclePacketData_IbcPacketPacket:
		err := am.keeper.OnAcknowledgementIbcPacketPacket(ctx, modulePacket, *packet.IbcPacketPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcPacketPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.OraclePacketData_IbcPacketPacket:
		err := am.keeper.OnTimeoutIbcPacketPacket(ctx, modulePacket, *packet.IbcPacketPacket)
		if err != nil {
			return nil, err
		}
	default:
