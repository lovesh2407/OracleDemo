...
const baseQueryGetStockRequest = { id: 0 };
export const QueryGetStockRequest = {
    ...
    decode(input, length) {
        ...
        const message = { ...baseQueryGetStockRequest };
...
const baseQueryGetStockResponse = {};
export const QueryGetStockResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetStockResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllStockRequest = {};
export const QueryAllStockRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllStockRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllStockResponse = {};
export const QueryAllStockResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllStockResponse };
        message.Stock = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Stock(request) {
        ...
        const promise = this.rpc.request("lovesh2407.OracleDemo.oracle.Query", "Stock", data);
        return promise.then((data) => QueryGetStockResponse.decode(new Reader(data)));
    }
    StockAll(request) {
        const data = QueryAllStockRequest.encode(request).finish();
        const promise = this.rpc.request("lovesh2407.OracleDemo.oracle.Query", "StockAll", data);
        return promise.then((data) => QueryAllStockResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
